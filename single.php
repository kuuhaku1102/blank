                ...
                if(!empty($smart_sections) && is_array($smart_sections)) {
                    foreach($smart_sections as $sec) {
                        ...
                        if(!empty($sec['anim']) && $sec['anim'] !== 'none') {
                            echo '<div style="margin-top:0; margin-bottom:40px; text-align:center;">';
                            ...
                            if($sec['anim'] === 'custom_image' && !empty($sec['img'])) {
                                ...
                                // Animated Tech Logo generated by CSS (SVG-like)
                                echo '<div style="max-width:100%; height:300px; margin:0 auto; border-radius:16px; overflow:hidden; box-shadow:0 10px 30px rgba(0,0,0,0.05);">';
                                echo blank_get_animated_logo_html('large');
                                echo '</div>';
                            }
